...
while True:
    ...
    if respuesta == 'europa': #Esto indica que si Europa es la seleccionada, se pasara a la siguiwntw ronda

        print('Es correcto ✅​, siguiente pregunta')
        print(f'Te queda {vida} vidas')
        break

    elif respuesta in ['asia', 'oceania', 'america']: #Pero aqui, si el usuario no acierta y dice una de estas 3, se restara una vida de las 10 que tiene
